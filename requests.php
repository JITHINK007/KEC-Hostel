	...
	<table class="table table-striped table-bordered">
		<thead >
		  ...
		  <tbody id="myTable">
			  ...
			  //===================================================================================================
				$query="SELECT * FROM `perpermissions_details` WHERE `status`='PENDING' ORDER BY `ID` DESC ";
			  ...
			  while($row = mysqli_fetch_array($sql))
			  {
					echo "<tr  scope='row'>
						...
						<td><a class='btn btn-success' href='acceptdata.php?q=".$row['ID']."'>Accept</a></td>
						<td><a  class='btn btn-danger' href='rejectreason.php?q=".$row['ID']."'>Reject</a></td>
					 </tr>";
			  }
