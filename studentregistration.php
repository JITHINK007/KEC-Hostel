                            ...
                            <form action="studentregistrationdata.php" role="form" method="POST">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="studentname" class="form-control rounded-pill"
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="rollnumber" class="form-control rounded-pill"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" id="birthday" name="dateofbirth"
                                            class="form-control rounded-pill" placeholder="DateOfBirth" required />
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <select id="stream" name="stream" class="form-control rounded-pill" required>
                                ...
                                <div class="form-group" id="branchGroup">
                                    <div class="input-group">
                                        ...
                                        <select id="branch" name="branch" class="form-control rounded-pill" required>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="father_guardianname"
                                            class="form-control rounded-pill" placeholder="Father / Guardian Name"
                                            required />
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="tel" name="father_guardiannumber"
                                            class="form-control rounded-pill" placeholder="Father / Guardian Number"
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="tel" name="room_number" class="form-control rounded-pill"
                                            placeholder="Room Number" pattern="[0-9]{3}" required />
...
<script>
    $(document).ready(function () {
        // Initially hide the branch selection
        $("#branchGroup").hide();

        // Add change event listener to the stream selection
        $("#stream").change(function () {
            // Check if the selected stream is MBA, MSC, or Diploma
            if ($(this).val() === "MBA" || $(this).val() === "MSC" || $(this).val() === "Diploma") {
                // If yes, hide the branch selection and remove the required attribute
                $("#branchGroup").hide();
                $("#branch").removeAttr("required");
            } else {
                // If no, show the branch selection and add the required attribute
                $("#branchGroup").show();
