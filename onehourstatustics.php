...
<!--===================================================================================================================================================-->
<div>
	<h1 style="margin:-3% 0% 0% 0%;">Evening Statistics:</h1>
</div>
<!---<?PHP
include "connect.php";
...
<center>
	<div class="main">
		...
		<?PHP
			include 'connect.php';
			$sql = "SELECT `leavingdatetime` FROM `perpermissions_details` WHERE `status`='ACCEPTED' AND  `prmissiontype`='Evening Permission'";
