...
$logintype="student";
//============================================================================
$query="INSERT INTO `student_details` (`studentname`, `rollnumber`, `dateofbirth`, `stream`, `branch`, `father/guardianname`, `father/guardiannumber`,`roomnumber`, `address`)VALUES ('$studentname','$rollnumber','$dateofbirth','$strem','$branch','$father_guardianname','$father_guardiannumber','$roomnumber','$address')";
